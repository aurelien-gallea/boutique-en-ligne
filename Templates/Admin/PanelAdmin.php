      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                    <button id="products" class="flex items-center w-full p-2 text-sm font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                      Ajouter un produit
                    </button>
                  </li>
                  <li>
                    <button id="categories" class="flex items-center w-full p-2 text-sm font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                      Collection
                    </button>
                  </li>
                  <li>
...
<div class="p-4 sm:pl-64 pt-[57px] h-[100vh] bg-slate-100 dark:bg-gray-600">
    <iframe id="addProduct" class="w-full h-full hidden" src="./iframe/addProduct.php" frameborder="0" style="display:none;"></iframe>
    <iframe id="allCategories" class="w-full h-full hidden" src="./iframe/AllCategories.php" frameborder="0"></iframe>
</div>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.6.5/flowbite.min.js"></script>
    <script src="../../assets/js/admin/PanelAdmin.js"></script>
