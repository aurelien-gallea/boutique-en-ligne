...
use PDO;
class Price { // Déclaration de la classe User qui hérite de la classe DBManager
    
    private $_id;
    private $_value;
    
    const TABLE_NAME = "price"; // Déclaration d'une constante de classe appelée TABLE_NAME avec la valeur "user"
