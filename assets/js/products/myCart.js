...
fetch(`${keyPath}checkMyCart.php`)
  ...
  .then((data) => {
    if (data.cart.length !== 0) {
      ...
      for (const key in data.cart) {
        ...
        const child3 = addElement("select", ["size","block", "p-2", "text-sm", "text-gray-900", "border", "border-gray-300", "rounded-lg", 'bg-gray-50', 'focus:ring-blue-500', 'focus:border-blue-500', 'dark:bg-gray-900', 'dark:border-gray-600', 'dark:placeholder-gray-500', 'dark:text-gray-400', 'dark:focus:ring-blue-500', "dark:focus:border-blue-500"], {
          name: item.sizeId,
          value: item.size,
        });
        ...
        const child4 = addElement(
          "input",
          ["quantity","block", "w-20","h-[38px]", "p-2", "text-gray-900", "border", "border-gray-300", "rounded-lg", "bg-gray-50", "sm:text-xs", "focus:ring-blue-500", "focus:border-blue-500", "dark:bg-gray-900", "dark:border-gray-600", "dark:placeholder-gray-400", "dark:text-gray-400", "dark:focus:ring-blue-500", "dark:focus:border-blue-500"],
  ...
  // </div>`;
        ...
        child4.addEventListener("change", () => {
          ...
          // child4.value = child4.textContent
